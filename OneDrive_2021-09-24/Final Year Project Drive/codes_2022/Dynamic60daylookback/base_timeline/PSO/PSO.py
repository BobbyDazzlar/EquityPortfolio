...
sh_hptuning=study.trials_dataframe()
sh_hptuning.to_csv("/home/pn_kumar/Karthik/staticlookback30/PSO_sharpe_hps.csv")
...
optimal_portfolio.T.to_csv('/home/pn_kumar/Karthik/staticlookback30/PSO(sharpe)_optimal_portfolio.csv')
...
study = optuna.create_study(direction='maximize')
study.optimize(objective, n_trials=50)
hptuning = study.trials_dataframe()
hptuning.to_csv("/home/pn_kumar/Karthik/staticlookback30/PSO_sortino_hps.csv")
best = study.best_params
...
optimal_portfolio_sortino.T.to_csv('/home/pn_kumar/Karthik/staticlookback30/PSO(sortino)_optimal_portfolio.csv')
