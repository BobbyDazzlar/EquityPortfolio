...
df = pd.read_csv("/home/pn_kumar/Karthik/window-sliding/n50.csv")
...
n50 = pd.read_csv('/home/pn_kumar/Karthik/window-sliding/n50.csv', parse_dates=['Date'], index_col='Date')
n50 = n50.iloc[:row, :]
