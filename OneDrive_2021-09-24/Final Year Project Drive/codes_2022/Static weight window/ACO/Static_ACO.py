...
df = pd.read_csv("/home/pn_kumar/kka/Static_window/Static_ACO/n50_filtered_1_march.csv", parse_dates=['Date'],
...
sh_hptuning.to_csv("/home/pn_kumar/kka/Static_window/Static_ACO/Static_ACO_sharpe_hps.csv")
...
sharpe_portfolio = {'Returns': sharpe_portfolio_return, 'Standard Deviation': sharpe_portfolio_risk,
                    'Sharpe Ratio': sharpe_portfolio_shratio}
...
sharpe_pc*=100
sharpe_pc['Sharpe Ratio']/=100
sharpe_optimal = sharpe_pc.iloc[sharpe_pc['Sharpe Ratio'].idxmax()]
sharpe_optimal = pd.DataFrame(sharpe_optimal)

sharpe_optimal.to_csv("/home/pn_kumar/kka/Static_window/Static_ACO/Static_ACO_sharpe_optimal.csv")
sharpe_pc.to_csv('/home/pn_kumar/kka/Static_window/Static_ACO/Staic_ACO_sharpe_portfolio.csv')
...
hptuning.to_csv("/home/pn_kumar/kka/Static_window/Static_ACO/Static_ACO_sortino_hps.csv")
...
sortino_pc*=100
sortino_pc['Sortino Ratio']/=100
sortino_optimal = sortino_pc.iloc[sortino_pc['Sortino Ratio'].idxmax()]
sortino_optimal = pd.DataFrame(sortino_optimal)

sortino_optimal.to_csv("/home/pn_kumar/kka/Static_window/Static_ACO/Static_ACO_sortino_optimal.csv")

sortino_pc.to_csv('/home/pn_kumar/kka/Static_window/Static_ACO/Static_ACO_sortino_portfolio.csv')
